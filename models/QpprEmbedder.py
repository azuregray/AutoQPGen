...
def QpprEmbedder(cie_number, dept_name, semester, course_name, elective_choice, date, timings, course_code, max_marks, mandatory_count, q1a, co1a, lvl1a, marks1a, q1b, co1b, lvl1b, marks1b, q2a, co2a, lvl2a, marks2a, q2b, co2b, lvl2b, marks2b, q3a, co3a, lvl3a, marks3a, q3b, co3b, lvl3b, marks3b, q4a, co4a, lvl4a, marks4a, q4b, co4b, lvl4b, marks4b):
    ...
    <body>
        <div style="display: flex; align-items: center; justify-content: center; padding: 20px; text-align: center;">
            ...
            <div style="margin: 5px 0;">
                ...
                <p style="font-family: 'SF Pro Display'; font-size: x-small; margin: 5px 0;">(Accredited by NAAC, Approved by A.I.C.T.E., New Delhi, Recognised by Govt. of Karnataka & Affiliated to V T U, Belagavi)</p>
                <p style="font-family: 'SF Pro Display'; font-size: medium; margin: 5px 0;">#29, Chimney Hills, Hesaraghatta Main Road, Chikkabanavara Post, Bengaluru - 560090</p>
            </div>
        </div>
        <hr>
        ...
        <table>
            <tr>
                ...
                <td colspan="2">Elective: {elective_choice}</td>
            </tr>
            <tr>
                <td>Date: {date}</td>
                <td>Timings: {timings}</td>
                <td>C Code: {course_code}</td>
                <td colspan="2">Max Marks: {max_marks}</td>
            </tr>
            <tr>
                <td colspan="5" style="font-weight: bold; text-align: center">Note: Answer ANY {mandatory_count} full questions. All questions carry 20 marks.</td>
            </tr>
            ...
            <tr>
                <td style="text-align:center;" colspan="5">OR</td>
            </tr>
            <tr>
